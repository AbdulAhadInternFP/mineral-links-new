<x-layout title="Transactions">
    <div id="reconciliation_alert"
        class="flex items-center justify-between bg-white border-l-4 border-brand-terracotta rounded-r-lg shadow-sm px-6 py-1 mb-6">
    ...
    <section id="invoices_table_section" class="bg-white rounded-xl shadow overflow-hidden">
                    ...
                    @foreach ($months as $index => $month)
                        ...
                        <tr class="hover:bg-brand-sage/10 transition-colors">
                            ...
                            <td class="px-6 py-1 text-center">
                                <button class="text-gray-400 hover:text-brand-teal transition-colors">
        ...
        <div class="px-6 py-1 bg-gray-50 border-t border-gray-200 flex items-center justify-between">
            <div class="text-sm text-gray-600">
                <span class="font-medium">12</span> matched line items ready to post
            </div>
            <button id="post-to-qb-btn"
                class="bg-brand-teal text-white font-semibold px-6 py-1.5 rounded-lg hover:bg-brand-teal/90 transition-colors text-sm flex items-center">
